...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_2PHASE_ONDEMAND)
extern struct cpufreq_governor cpufreq_gov_2phase_ondemand;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_2phase_ondemand)
